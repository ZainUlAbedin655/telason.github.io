        ...
        <td class='text-right'>
            <div class="btn-group-action">
                <div class="btn-group pull-right">
                    <a class='btn btn-default' href="{$edit_url|escape:'htmlall':'UTF-8' nofilter}=tab_id" title="{l s='Edit' mod='anproductextratabs'}">
                    ...
                    <ul class="dropdown-menu" role="menu">
                        <li>
                            <a href="{$delete_url|escape:'htmlall':'UTF-8' nofilter}=tab_id" title="{l s='Delete' mod='anproductextratabs'}">
...
<div class='panel col-lg-12'>
    <div class='panel-heading'>
        ...
        <span class="panel-heading-action">
            <a class="list-toolbar-btn" href="{$edit_url|escape:'htmlall':'UTF-8' nofilter}">
