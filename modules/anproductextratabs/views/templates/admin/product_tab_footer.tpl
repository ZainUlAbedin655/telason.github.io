...
<script type='text/javascript'>
    ...
    jQuery(document).ready(function () {
        jQuery("[name='submit_tabs']").on('click', function () {
            ...
            (jQuery('#content_title_'+id_anproducttabs+'_'+{$lang.id_lang|intval}).val(), tinyMCE.get('content_content_'+id_anproducttabs+'_'+{$lang.id_lang|intval}).getContent());
        {/foreach}
    ...
    jQuery('.translations.tabbable').each(function () {
        ...
        jQuery('.translationsFields-'+id+'_{$language['id_lang']|intval}').removeClass('visible');
        jQuery('.translationsFields-'+id+'_{$language['id_lang']|intval}').removeClass('active');
        {/foreach}
        {if $morenew}
