...
<div class="product-variants price-rules-product-variants">
  <div class="panel-group" id="accordion">
        <div class="panel panel-default">
          <div class="panel-collapse collapse in">
            <div class="panel-body">
              {foreach from=$groups key=id_attribute_group item=group}
               <div class="clearfix product-variants-item  {if $group.name == 'Shell Size'}col-md-6 nopaddingl {/if}{if $group.name == 'Cable Entry'}col-md-6 nopaddingr{/if}" style="margin-bottom: 3px;">
                <span class="control-label">{$group.name}</span>
                {if $group.group_type == 'select'}
                  <select
                    class="form-control edge"
