    ...
    <div class="panel-heading datasheets">
      <h4 class="panel-title">
        <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo">
          <h4 style="font-size:16px;">Technical Datasheets</h4>
        </a>
      </h4>
    </div>
...
<a class="btn btn-primary" style="width:100%; margin-top:16px; font-size:15px; font-weight:600; " href="https://www.telason.com/329-need-pricing-and-availability">Pricing Request</a>
