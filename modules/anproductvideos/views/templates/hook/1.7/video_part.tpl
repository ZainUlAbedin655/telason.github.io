...
<div class="video_frame">
    ...
    <div class="video-preview">
        <iframe type="text/html" id="test1" class="videoYoutubePlayer" frameborder="0" src="{$video|escape:'htmlall':'UTF-8'}?enablejsapi=1&version=3&html5=1&showinfo={$apv_configuration['ANPRODUCTVIDEOS_YOUTUBE_INFO']|intval}&disablekb={$apv_configuration['ANPRODUCTVIDEOS_YOUTUBE_DISABLE_KEYBOARD_CONTROL']|intval}&autoplay={$apv_configuration['ANPRODUCTVIDEOS_YOUTUBE_ALLOW_AUTOPLAY']|intval}&controls={$apv_configuration['ANPRODUCTVIDEOS_YOUTUBE_ALLOW_CONTROLS']|intval}{if $apv_configuration['ANPRODUCTVIDEOS_YOUTUBE_VIDEO_ANNOTATION'] == 0}&iv_load_policy=3{/if}"
        {if $apv_configuration['ANPRODUCTVIDEOS_YOUTUBE_FULL_SCREEN'] == 1} allow="autoplay; encrypted-media" webkitAllowFullScreen mozallowfullscreen allowFullScreen{/if}
        ></iframe>
    </div>
    {elseif $type == 'vimeo'}
    <div class="video-preview">
        <iframe class="videoVimeoPlayer" src="{$video|escape:'htmlall':'UTF-8'}?autoplay={$apv_configuration['ANPRODUCTVIDEOS_VIMEO_ALLOW_AUTOPLAY']|intval}&loop={$apv_configuration['ANPRODUCTVIDEOS_VIMEO_LOOP']|intval}&byline={$apv_configuration['ANPRODUCTVIDEOS_VIMEO_BYLINE']|intval}&title={$apv_configuration['ANPRODUCTVIDEOS_VIMEO_TITLE']|intval}" width="100%" height="auto" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>
    </div>
