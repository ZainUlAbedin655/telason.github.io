...
<div class="form-group bootstrap ">
  <label class="control-label col-lg-3 pull-left label-fix" for="anproductvideos_video">
    ...
    <span class="label-tooltip" title="{l s='Enter link to video(Youtube, Vimeo) here. Invalid characters <>;=#{}' mod='anproductvideos'}">{l s='YouTube/Vimeo Link' mod='anproductvideos'}</span>
  </label>
  <div class="col-lg-9 col-sm-12 col-md-12 pull-left">
...
{*</div>*}
<div class="form-group">
  <label class="control-label col-lg-3 pull-left label-fix" for="name_{$id_lang|intval}">
    <span class="label-tooltip" title="{l s='Enter heading to video. Invalid characters <>;=#{}' mod='anproductvideos'}">
      {l s='Heading' mod='anproductvideos'}
    </span>
  </label>
  <div class="col-lg-9 col-sm-12 col-md-12 pull-left">
...
<div class="form-group">
  <label class="control-label col-lg-3 pull-left label-fix" for="anproductvideos_description_{$id_lang|intval}">
    <span class="label-tooltip" title="{l s='Video description' mod='anproductvideos'}">
      {l s='Description' mod='anproductvideos'}
    </span>
  </label>
  <div class="col-lg-9 col-sm-12 col-md-12 pull-left">
    <div class="translations tabbable" id="anproductvideos_description">
      ...
      {foreach from=$languages item=language}
        {if $languages|count > 1}
        <div class="translationsFields-anproductvideos_description_{$language.id_lang|intval} tab-pane mce-textarea translation-label-{$language.iso_code|escape:'htmlall':'UTF-8'}">
        {/if}
            <textarea id="anproductvideos_description_{$language.id_lang|intval}" name="anproductvideos_description_{$language.id_lang|intval}" class="autoload_rte textarea-autosize"></textarea>
