...
$fontSizes = array('10px', '11px', '12px', '13px', '14px', '15px', '16px', '17px', '18px', '19px', '20px', '21px', '22px', '23px', '24px', '25px', '26px', '27px', '28px', '29px', '30px', '31px', '32px', '33px', '34px', '35px', '36px', '37px', '38px', '39px', '40px',
);
...
/*                     'logoMiddle' => array(
            ...
            'topmenu' => array(
                ...
                'options' => array(
                    ...
                    'menuLinkColor' => array(
                        'title' => $module->l('Menu Links Color'),
                        'description' => $module->l(''),
                        'source' => 'picker',
                        'default' => '#ffffff',
                    ),
                    'menuLinkColorHover' => array(
                        'title' => $module->l('Menu Links Color Hover'),
                        'description' => $module->l(''),
                        'source' => 'picker',
                        'default' => '#ffffff',
                    ),
                ...
                'title' => $module->l('Product'),
                 'options' => array(
                    ...
                    'slideronproductpage' => array(
                     ...
                     'addtocart' => array(
                         'title' => $module->l('Quick purchase bar'),
                         'description' => $module->l(''),
                         'source' => 'select',
                         'options' => array(
                             'without' => 'Disable Quick purchase bar',
                             'button' => 'Add to cart button only',
                             'qtyandbutton' => 'Add to cart button and quantity bar',
                         ),
                         'default' => '',
                         'type' => 'selectFileAdd',
                         'files' => array(
