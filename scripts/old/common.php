...
$sheets[2]['SBH45'] = 100; //$88.60 // ok
$sheets[3]['SBH90'] = 101; //$78.21 // ok
$sheets[4]['TBH00'] = 102; //$72.76 // ok
$sheets[5]['TBH45'] = 103; //$105.50 // ok
$sheets[6]['TBH90'] = 104; //$93.13  // ok*/
sheetsrun($excel,$sheets);
function sheetsrun($excel,$sheets){
                                    ...
                                    try{
                                        ...
                                        foreach($qty_heads as $key2 => $qty_head){
                                            ...
                                            if($qtyCounter == 1 && $qty_head == '1+'){
                                                ...
                                                $qty1Price = $qty1Price * 0.8;
                                            }
                                            $priceLess = (($realPrice - $codeSImpact) * $impactMultipler) + $codeSImpact;
                                            $combination[$key][$ref][$code]['qty'][$qty_head]['price']['usd'] = $priceLess * 0.8;
