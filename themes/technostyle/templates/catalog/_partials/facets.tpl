        ...
        <section class="facet clearfix">
          ...
          <div class="title">
            ...
            <span class="float-xs-right">
              <span class="collapse-icons {if $facetedsearch == 'turnon'} collapsed{elseif $facetedsearch == 'turnoff'} expanded{/if}"  data-target="#facet_{$_expand_id}" data-toggle="collapse"{if !$_collapse} aria-expanded="true"{/if}>
