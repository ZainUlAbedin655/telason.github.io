...
<div class="product-miniature js-product-miniature" data-id-product="{$product.id_product}" data-id-product-attribute="{$product.id_product_attribute}" itemscope itemtype>
...
-->			</a>		
    ...
    <div class="product-description">
      {block name='product_name'}
        <h2 class="h2 product-title" itemprop="name"><a href="{$product.url}" title="{$product.name}" title="{$product.name}">{$product.name}</a></h2>
      {/block}
      	        <!-- <pre>
      	{$product.category|print_r}
      	{$category.name|print_r}
      	</pre> -->
      {block name='`'}
