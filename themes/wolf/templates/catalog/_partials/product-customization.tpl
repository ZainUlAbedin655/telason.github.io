...
<section class="product-customization">
  {if !$configuration.is_catalog}
    <div class="card card-block">
      <h3 class="h4 card-title">{l s='Product customization' d='Shop.Theme.Global'}</h3>
      ...
      <form method="post" action="{$product.url}" enctype="multipart/form-data">
            ...
            <li class="product-customization-item">
              ...
              {if $field.type == 'text'}
                ...
                <small class="float-xs-right">{l s='250 char. max' d='Shop.Forms.Help'}</small>
                  {if $field.text !== ''}
                      <h6 class="customization-message">{l s='Your customization:' d='Shop.Theme.Global'}
              ...
              {elseif $field.type == 'image'}
                {if $field.is_customized}
                  ...
                  <a class="remove-image" href="{$field.remove_image_url}" rel="nofollow">{l s='Remove Image' d='Shop.Theme.Global'}</a>
                {/if}
                <span class="custom-file">
                  ...
                  <button class="btn btn-primary">{l s='Choose file' d='Shop.Theme.Global'}</button>
                </span>
        ...
        <div class="clearfix">
          <button class="btn btn-primary float-xs-right" type="submit" name="submitCustomizedData">{l s='Save Customization' d='Shop.Theme.Global'}</button>
        </div>
      </form>
      {/block}
