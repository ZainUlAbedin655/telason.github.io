      ...
      <table id="order-products" class="table table-bordered return">
        <thead class="thead-default">
          <tr>
            ...
            <th>{l s='Product' d='Shop.Theme.Global'}</th>
            <th>{l s='Quantity' d='Shop.Theme.Global'}</th>
            <th>{l s='Returned' d='Shop.Theme.Customeraccount'}</th>
            <th>{l s='Unit price' d='Shop.Theme.Global'}</th>
            <th>{l s='Total price' d='Shop.Theme.Global'}</th>
          </tr>
        </thead>
          ...
          <tr>
            ...
            <td>
              ...
              {if $product.reference}
                {l s='Reference' d='Shop.Theme.Global'}: {$product.reference}<br/>
              {/if}
              {if $product.customizations}
            ...
            <div class="content">
              <div class="row">
                <div class="col-sm-5 desc">
                  ...
                  {if $product.reference}
                    <div class="ref">{l s='Reference' d='Shop.Theme.Global'}: {$product.reference}</div>
                  {/if}
                  {if $product.customizations}
                    {foreach $product.customizations as $customization}
                      <div class="customization">
                ...
                <div class="col-sm-7 qty">
                  <div class="row">
                    ...
                    <div class="col-xs-4">
                      {if $product.customizations}
                        {foreach $product.customizations as $customization}
                          <div class="q">{l s='Quantity' d='Shop.Theme.Global'}: {$customization.quantity}</div>
                          <div class="s" id="_mobile_return_qty_{$product.id_order_detail}_{$customization.id_customization}"></div>
                        {/foreach}
                      {else}
                        <div class="q">{l s='Quantity' d='Shop.Theme.Global'}: {$product.quantity}</div>
                        {if $product.quantity > $product.qty_returned}
