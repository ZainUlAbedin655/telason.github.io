...
<section class="crosssell-products clearfix">
	<h2 class="h1 products-section-title text-uppercase">
		{l s='Customers who bought this product also bought:' d='Shop.Theme.Global'}
	</h2>
	<div class="products">
		...
		{foreach from=$products item="product"}
			<li class="{if $productCount >= $sliderFor}item{else}product_item col-xs-12 col-sm-4 col-md-3 col-lg-3{/if}">
