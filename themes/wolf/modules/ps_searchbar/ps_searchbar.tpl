...
<div id="search_widget" class="col-md-5 col-sm-12 search-widget" data-search-controller-url="{$search_controller_url}">
	...
	<form method="get" action="{$search_controller_url}">
		...
		<input type="text" name="s" value="{$search_string}" placeholder="{l s='Search' d='Shop.Theme.Global'}">
