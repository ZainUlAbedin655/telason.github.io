...
<div id="_desktop_currency_selector">
  <div class="currency-selector dropdown js-dropdown">
    <span  class="currency-title hidden-md-down">{l s='Currency:' d='Shop.Theme.Global'}</span>
    <!--<span class="expand-more _gray-darker hidden-md-down" data-toggle="dropdown">{$current_currency.iso_code} {$current_currency.sign}</span>
