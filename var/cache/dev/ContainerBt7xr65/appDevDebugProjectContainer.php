...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('ARpqpkrvSP', 0, ($this->targetDirs[0].'/pools'));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('rduaijnFcC', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = ${($_ = isset($this->services['doctrine.dbal.connection_factory']) ? $this->services['doctrine.dbal.connection_factory'] : $this->services['doctrine.dbal.connection_factory'] = new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory(array())) && false ?: '_'}->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => '', 'dbname' => 'telaso5_nexus', 'user' => 'telaso5_nexus', 'password' => 'cAT9@7#&M', 'charset' => 'UTF8', 'driverOptions' => array(1002 => 'SET sql_mode=(SELECT REPLACE(@@sql_mode,\'ONLY_FULL_GROUP_BY\',\'\'))'), 'serverVersion' => 5.0999999999999996447286321199499070644378662109375, 'defaultTableOptions' => array()), $a, $c, array('enum' => 'string'));
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_6de68085474c88345767965bf6b83b3c202f05b60808833cf773bfbe84979aab');
    ...
    {
        return $this->services['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('m6nWKPswEW', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('uc47puWkJT', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['fragment.listener'] = new \Symfony\Component\HttpKernel\EventListener\FragmentListener(${($_ = isset($this->services['uri_signer']) ? $this->services['uri_signer'] : $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('rxOIhkqziRPYfH6k0xCCFXhtIxgjWmZj2EXDnnvhhsz6AAKnS7Yz2ikI')) && false ?: '_'}, '/_fragment');
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('rxOIhkqziRPYfH6k0xCCFXhtIxgjWmZj2EXDnnvhhsz6AAKnS7Yz2ikI');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.active_modules' => array(
                ...
                7 => 'ps_categorytree',
                8 => 'ps_checkpayment',
                9 => 'ps_currencyselector',
                10 => 'ps_customeraccountlinks',
                11 => 'ps_customersignin',
                12 => 'ps_customtext',
                13 => 'ps_emailsubscription',
                14 => 'ps_facetedsearch',
                15 => 'ps_featuredproducts',
                16 => 'ps_imageslider',
                17 => 'ps_languageselector',
                18 => 'ps_linklist',
                19 => 'ps_mainmenu',
                20 => 'ps_searchbar',
                21 => 'ps_sharebuttons',
                ...
                25 => 'pagesnotfound',
                26 => 'sekeywords',
                27 => 'statsbestcategories',
                28 => 'statsbestcustomers',
                ...
                51 => 'psaddonsconnect',
                52 => 'blockreassurance',
                53 => 'ps_legalcompliance',
                54 => 'autoupgrade',
                55 => 'ps_categoryproducts',
                56 => 'ps_viewedproduct',
                57 => 'ps_crossselling',
                58 => 'ps_contactinfo',
                59 => 'pst_bannercmsblock',
                60 => 'pst_imageslider',
                61 => 'pst_serviceblock',
                62 => 'pst_featuredproducts',
                63 => 'pst_newproducts',
                64 => 'pst_bestsellers',
                65 => 'pst_categorycmsblock',
                66 => 'pst_subbanner',
                67 => 'pst_footerlink',
                68 => 'pst_blockaboutus',
                69 => 'pst_leftbanner',
                70 => 'pst_sidebestsellers',
                71 => 'pst_sidespecials',
                72 => 'pst_sidefeaturedproducts',
                73 => 'pst_sidenewproducts',
                74 => 'pst_imagehover',
                75 => 'anproductextratabs',
                76 => 'anproductvideos',
                77 => 'anscrolltop',
                78 => 'an_theme',
                79 => 'anthemeblocks',
                ...
                84 => 'dashproducts',
                85 => 'gsitemap',
                86 => 'ps_ipaytotalpayment',
            ),
            'container.autowiring.strict_mode' => true,
            'container.dumper.inline_class_loader' => false,
            'database_host' => '127.0.0.1',
            'database_port' => '',
            'database_name' => 'telaso5_nexus',
            'database_user' => 'telaso5_nexus',
            'database_password' => 'cAT9@7#&M',
            'database_prefix' => 'ps_',
            ...
            'secret' => 'rxOIhkqziRPYfH6k0xCCFXhtIxgjWmZj2EXDnnvhhsz6AAKnS7Yz2ikI',
            'ps_caching' => 'CacheMemcache',
            'ps_cache_enable' => false,
            'ps_creation_date' => '2018-06-19',
            'locale' => 'en-US',
            'cookie_key' => 'TfIoMC8Y7i21QQMTG2uVIQmOkmtASHPEqEJTM8HVjsapPYSVWQks3BRx',
            'cookie_iv' => 'Q8bt1ioM',
            'new_cookie_key' => 'def00000f3948e3b8e4c1ab56834b71740ab1f5a35e8e79d131fe85589568673cb3e8ee8f3841d49e53625a38d9ed9355731ff6398a6cdd245b5b9d16c819ba13e94489f',
            'cache.driver' => 'array',
            ...
            'kernel.secret' => 'rxOIhkqziRPYfH6k0xCCFXhtIxgjWmZj2EXDnnvhhsz6AAKnS7Yz2ikI',
