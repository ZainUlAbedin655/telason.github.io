...
$catalogue = new MessageCatalogue('en-US', array (
  ...
  'ShopThemeGlobal' => 
  array (
    '%copyright% %year% - Ecommerce software by %prestashop%' => '%copyright% %year% - Development Partner Creative Tech Solutions',
    'Undefined' => 'Undefined',
    'Home' => 'Home',
    'Addresses' => 'Addresses',
  ...
  array (
    ...
    'Data integrity is not valided. Hack attempt?' => 'Data integrity is not validated. Hack attempt?',
...
Thanks for your patience.',
  ...
  array (
    ...
    'The value of the PHP.ini setting "max_input_vars" must be increased to %value% in order to be able to submit the product form.' => 'The value of the setting "max_input_vars" in the PHP.ini file must be increased to %value% in order to be able to submit the product form.',
  ...
  array (
    ...
    'Parent' => 'Parent',
    'Save' => 'Save',
    'Configure your checkboxes' => 'Configure your checkboxes',
    'Please customize your consent request messages in the dedicated fields below :' => 'Please customize your consent request messages in the dedicated fields below:',
    'We recommend you to put a link to your confidentiality policy page in each of your custom messages. Be aware that a dedicated confidentiality policy page is required on your website; if you do not have one yet, please click' => 'We recommend you to put a link to your confidentiality policy page in each of your custom messages. Be aware that a dedicated confidentiality policy page is required on your website; if you do not have one yet, please click',
    'here' => 'here',
    'Account creation form' => 'Account creation form',
    'YES' => 'YES',
    'NO' => 'NO',
    'Consent request message' => 'Consent request message',
    'This message will be displayed on the customer creation form' => 'This message will be displayed on the customer creation form',
    'Customer account area' => 'Customer account area',
    'This message will be displayed in the My personal information tab in the customer account' => 'This message will be displayed in the My personal information tab in the customer account',
    'This message will be accomplanied by a checkbox' => 'This message will be accompanied by a checkbox',
    'For other installed modules requiring consent confirmation, they will be displayed in this tab only if they have done the GDPR update. The corresponding fields will automatically appear in order for you to customize the consent confirmation checkboxes.' => 'For other installed modules requiring consent confirmation, they will be displayed in this tab only if they have done the GDPR update. The corresponding fields will automatically appear in order for you to customize the consent confirmation checkboxes.',
    'Cancel' => 'Cancel',
    'Uninstall module?' => 'Uninstall module?',
    'Disable module?' => 'Disable module?',
    'Reset module?' => 'Reset module?',
    'You are about to uninstall' => 'You are about to uninstall',
    'This will definitely disable the module.' => 'This will definitely disable the module.',
    'You are about to disable ' => 'You are about to disable ',
    'Your current settings will be saved, but the module will no longer be active.' => 'Your current settings will be saved, but the module will no longer be active.',
    'You are about to reset ' => 'You are about to reset ',
    'This will restore the defaults settings.' => 'This will restore the defaults settings.',
    'This action cannot be undone.' => 'This action cannot be undone.',
    'Yes, uninstall it' => 'Yes, uninstall it',
    'Yes, disable it' => 'Yes, disable it',
    ...
    'Footer' => 'Footer',
    'Create and manage Product Categories' => 'Create and manage Product Categories',
    'Create here a full range of categories and subcategories to classify your products and manage your catalog easily.' => 'Create here a full range of categories and subcategories to classify your products and manage your catalog easily.',
    'Create content pages' => 'Create content pages',
    'Add and manage your content pages (CMS pages : Terms and conditions of use, Our stores, About us, etc.) as you want.' => 'Add and manage your content pages (CMS pages: Terms and conditions of use, Our stores, About us, etc.) as you want.',
    'Create Brands and Suppliers pages' => 'Create Brands and Suppliers pages',
    'This page allows you to create and manage your Brands and/or Suppliers pages.' => 'This page allows you to create and manage your Brands and/or Suppliers pages.',
    'Shop details' => 'Shop details',
    'Display additional information about your store or how to contact you to make it easy for your customers to reach you.' => 'Display additional information about your store or how to contact you to make it easy for your customers to reach you.',
    'Action on the module successfully completed' => 'Action on the module successfully completed',
    'Action on module failed' => 'Action on module failed',
    'install' => 'install',
    'Reset' => 'Reset',
    'and stay' => 'and stay',
    'From' => 'From',
    ...
    'To' => 'To',
    'Configure' => 'Configure',
    'Change colors, typography and your logo position' => 'Change colors, typography and your logo position',
    'Use the Theme configurator module to customize the main graphic elements of your website : colors, buttons, typography, logo position.' => 'Use the Theme configurator module to customize the main graphic elements of your website: colors, buttons, typography, logo position.',
    'Main theme modules cartography' => 'Main theme modules cartography',
    'There is no module for this section' => 'There is no module for this section',
    'You can install a module for this section from our Modules Selection' => 'You can install a module for this section from our Modules Selection',
    'See modules selection' => 'See modules selection',
    'See all theme\'s modules' => 'See all theme\'s modules',
    'Install' => 'Install',
    ...
    'Update my currencies' => 'Update my currencies',
    'Target link' => 'Target link',
    'Enter a description for this task.' => 'Enter a description for this task.',
    'Set the link of your cron task.' => 'Set the link of your cron task.',
    'Do not forget to use an absolute URL to make it valid! The link also has to be on the same domain as the shop.' => 'Do not forget to use an absolute URL to make it valid! The link also has to be on the same domain as the shop.',
    'Task frequency' => 'Task frequency',
    'At what time should this task be executed?' => 'At what time should this task be executed?',
    'On which day of the month should this task be executed?' => 'On which day of the month should this task be executed?',
    'On what month should this task be executed?' => 'On what month should this task be executed?',
    'On which day of the week should this task be executed?' => 'On which day of the week should this task be executed?',
    'Cron mode' => 'Cron mode',
    'Basic' => 'Basic',
    'Use the PrestaShop cron tasks webservice to execute your tasks.' => 'Use the PrestaShop cron tasks webservice to execute your tasks.',
    'Advanced' => 'Advanced',
    'For advanced users only: use your own crontab manager instead of PrestaShop cron tasks service.' => 'For advanced users only: use your own crontab manager instead of PrestaShop cron tasks service.',
    'The Advanced mode enables you to use your own cron tasks manager instead of PrestaShop cron tasks webservice.' => 'The Advanced mode enables you to use your own cron tasks manager instead of PrestaShop cron tasks webservice.',
    'First of all, make sure the \'curl\' library is installed on your server.' => 'First of all, make sure the \'curl\' library is installed on your server.',
    'To execute your cron tasks, please insert the following line in your cron tasks manager:' => 'To execute your cron tasks, please insert the following line in your cron tasks manager:',
    'Day' => 'Day',
    'Month' => 'Month',
    ...
    'Never' => 'Never',
    'Every day of the month' => 'Every day of the month',
    'Settings' => 'Settings',
    ...
    'Manage all your automated web tasks from a single interface.' => 'Manage all your automated web tasks from a single interface.',
    'To be able to use this module, please activate cURL (PHP extension).' => 'To be able to use this module, please activate cURL (PHP extension).',
    ...
    'Comply with the main requirements of the European General Data Protection Regulation thanks to this module developed by PrestaShop.' => 'Comply with the main requirements of the European General Data Protection Regulation thanks to this module developed by PrestaShop.',
    'Are you sure you want to uninstall this module?' => 'Are you sure you want to uninstall this module?',
    ...
    'There was an error during the desinstallation. Please contact us through Addons website' => 'There was an error during the desinstallation. Please contact us through Addons website',
    ...
    'Ape' => 'Ape',
    'Website' => 'Website',
    'Creation account date' => 'Creation account date',
    'Name' => 'Name',
    'Date' => 'Date',
    'Reference' => 'Reference',
    'Payment' => 'Payment',
    ...
    'No orders' => 'No orders',
    'Quantity' => 'Quantity',
    'Product(s) in the order' => 'Product(s) in the order',
    ...
    'Total products' => 'Total products',
    'No carts' => 'No carts',
    'Product(s) in the cart' => 'Product(s) in cart',
    'Messages' => 'Messages',
    'IP' => 'IP',
    ...
    'Easily configure and customize your homepage’s theme and main native modules. Feature available on Design > Theme & Logo page.' => 'Easily configure and customize your homepage’s theme and main native modules. Feature available on Design > Theme & Logo page.',
    ...
    'There was an error during the uninstall. Please contact us through Addons website' => 'There was an error during the uninstallation. Please contact us through Addons website',
    'Homepage Configuration' => 'Homepage Configuration',
    'Advanced Customization' => 'Advanced Customization',
    'Make sure you zip your edited theme files directly to the root of your child theme\'s folder before uploading it.' => 'Make sure you zip your edited theme files directly to the root of your child theme\'s folder before uploading it.',
    'Upload child theme' => 'Upload child theme',
    'You can edit your theme sheet by using the Parent/Child theme feature' => 'You can edit your theme sheet by using the Parent/Child theme feature',
    'Advanced use only.' => 'Advanced use only.',
    'Support team might not be able to assist you on issues created by your own child theme.' => 'Support team might not be able to assist you on issues created by your own child theme.',
    'Download your current theme' => 'Download your current theme',
    'You picked a theme but still want to bring some specific adjustments? Get a child theme, it will allow you to keep the parts you want and customize the others!' => 'You picked a theme but still want to bring some specific adjustments? Get a child theme, it will allow you to keep the parts you want and customize the others!',
    'Edit your child theme' => 'Edit your child theme',
    'Once the child theme created, next step is simple: apply the changes you want within the desired files, it will handle the customization part while keeping the parent theme’s look and functionality.' => 'Once the child theme created, next step is simple: apply the changes you want within the desired files, it will handle the customization part while keeping the parent theme’s look and functionality.',
    'Upload your child theme' => 'Upload your child theme',
    'As you only bring modification to the child theme, you can upgrade the parent theme easily, without losing your customization.' => 'As you only bring modification to the child theme, you can upgrade the parent theme easily, without losing your customization.',
    'Download theme' => 'Download theme',
    'Downloading' => 'Downloading',
    'How to use parents/child themes' => 'How to use parent/child themes',
    'Information' => 'Information',
    'By using this method you can override the CSS and html of your theme, and add analytics tags. You are not allowed to add new modules.' => 'By using this method you can override the CSS and HTML of your theme, and add analytics tags. You are not allowed to add new modules.',
    'Once uploaded, the child theme will be available in your Theme & Logo section' => 'Once uploaded, the child theme will be available in your Theme & Logo section',
    'You do not have permission to edit this.' => 'You do not have permission to edit this.',
    'An error occured, please check your zip file' => 'An error occurred, please check your zip file',
    'The file must be a ZIP file (.zip)' => 'The file must be a ZIP file (.zip)',
    'There is some PHP files in your ZIP' => 'There are some PHP files in your ZIP',
    'The theme already exists or the parent name in the config file is wrong' => 'The theme already exists or the parent name in the config file is wrong',
    'You must enter the parent theme name in the theme.yml file. Furthermore, the parent name must be the current parent theme.' => 'You must enter the parent theme name in the theme.yml file. Furthermore, the parent name must be the current parent theme.',
    'The child theme has been added successfully.' => 'The child theme has been added successfully.',
    ...
    'Protect your store from fraudulent payments' => 'Protect your store from fraudulent payments',
    ...
    'Prepaid account (MoneyBookers, PayPal...)' => 'Prepaid account (MoneyBookers, PayPal...)',
    'Please accept the terms of service.' => 'Please accept the terms of service.',
    'PrestaShop Security configuration' => 'PrestaShop Security configuration',
    'My shop does not have a PrestaShop Security account yet' => 'My shop does not have a PrestaShop Security account yet',
    'I already have an account' => 'I already have an account',
    'Your email' => 'Your email',
    'Shop Url' => 'Shop Url',
    'I agree with the terms of PrestaShop Security service and I adhere to them unconditionally.' => 'I agree with the terms of PrestaShop Security service and I adhere to them unconditionally.',
    ...
    'Choose a carrier type...' => 'Choose a carrier type...',
    'Payments' => 'Payments',
    'Payment Module' => 'Payment Module',
    'Payment Type' => 'Payment Type',
    'Choose a payment type...' => 'Choose a payment type...',
    'Email is invalid' => 'Email is invalid',
    'Shop URL is invalid' => 'Shop URL is invalid',
    'Impossible to create a new account, please report this bug on http://forge.prestashop.com/' => 'Impossible to create a new account, please report this bug on http://forge.prestashop.com/',
    'This order has not been sent to PrestaShop Security.' => 'This order has not been sent to PrestaShop Security.',
    'Scoring:' => 'Scoring:',
    'Unknown' => 'Unknown',
    'Report this order as a fraud to PrestaShop' => 'Report this order as a fraud to PrestaShop',
    'Pick up in-store' => 'Pick up in-store',
    'Withdrawal point' => 'Withdrawal point',
    'Slow shipping more than 3 days' => 'Slow shipping more than 3 days',
    'Shipping express' => 'Shipping express',
    'Download' => 'Download',
    'Read more about the CSV format at:' => 'Read more about the CSV format at:',
    'or' => 'or',
    'The locale must be installed' => 'The locale must be installed',
    'Multiple value separator' => 'Multiple value separator',
    'Comment:' => 'Comment:',
    'Newsletter subscription: Unable to delete customer using email.' => 'Newsletter subscription: Unable to delete customer using email.',
    'Newsletter subscription: Unable to export customer using email.' => 'Newsletter subscription: Unable to export customer using email.',
    ...
    'Do not forget to use an absolute URL in the target link to make it valid! The link also has to be on the same domain as the shop.' => 'Do not forget to use an absolute URL in the target link to make it valid! The link also has to be on the same domain as the shop.',
    'What does this module do?' => 'What does this module do?',
    'Originally, cron is a Unix system tool that provides time-based job scheduling: you can create many cron jobs, which are then run periodically at fixed times, dates, or intervals.' => 'Originally, cron is a Unix system tool that provides time-based job scheduling: you can create many cron jobs, which are then run periodically at fixed times, dates, or intervals.',
    'This module provides you with a cron-like tool: you can create jobs which will call a given set of secure URLs to your PrestaShop store, thus triggering updates and other automated tasks.' => 'This module provides you with a cron-like tool: you can create jobs which will call a given set of secure URLs to your PrestaShop store, thus triggering updates and other automated tasks.',
    'Error!' => 'Error!',
    'Warning!' => 'Warning!',
    'Success!' => 'Success!',
    'Type:' => 'Type:',
    ...
    'Data visualization and automatic actions' => 'Data visualization and automatic actions',
    'Find here listed all personal data collected by PrestaShop and your installed modules.' => 'Find here listed all personal data collected by PrestaShop and your installed modules.',
    'These data will be used at 2 different levels :' => 'These data will be used at 2 different levels:',
    'When a customer requests access to his data: he gets a copy of his personal data collected on your store.' => 'When a customer requests access to his/her data: he/she gets a copy of his/her personal data collected on your store.',
    'When a customer requests data erasure: if you accept his request, his data will be removed permanently.' => 'When a customer requests data erasure: if you accept his request, his/her data will be removed permanently.',
    'Compliant module list' => 'Compliant module list',
    'Find here listed all the elements that are GDPR compliant.' => 'Find here listed all the elements that are GDPR compliant.',
    'PrestaShop data' => 'PrestaShop data',
    ...
    'to know which data is defined as personal):' => 'to know which data is defined as personal):',
    'Please make sure that you have access to the latest version of these modules to fully benefit the GDPR update.' => 'Please make sure that you have access to the latest version of these modules to fully benefit the GDPR update.',
    'If they are still not displayed in the block above, we invite you to contact their respective developers to have more information about these modules. ' => 'If they are still not displayed in the block above, we invite you to contact their respective developers to have more information about these modules. ',
    'Manage customer\'s personal data' => 'Manage customer\'s personal data',
    'Search for an existing customer by typing the first letters of his/her name or email.' => 'Search for an existing customer by typing the first letters of his/her name or email.',
    'Search for a customer name OR email' => 'Search for a customer name OR email',
    'Eg: john doe ...' => 'Eg: john doe ...',
    'To visualize all the data that your store has collected from a specific customer, please click on the corresponding customer block' => 'To visualize all the data that your store has collected from a specific customer, please click on the corresponding customer block',
    ...
    'EMAIL' => 'EMAIL',
    'PHONE' => 'PHONE',
    'There is no result in the customer data base for' => 'There is no result in the customer database for',
    'If you are looking for someone without a customer account, please search for the complete email address or phone number he left.' => 'If you are looking for someone without a customer account, please search for the complete email address or phone number he left.',
    'However you can continue the erasure process for this address (only for modules that have done the GDPR update).' => 'However, you can continue the erasure process for this address (only for modules that have done the GDPR update).',
    'Get started' => 'Get started',
    'Personal data management' => 'Personal data management',
    'Consent checkbox customization' => 'Consent checkbox customization',
    'Customer activity tracking' => 'Customer activity tracking',
    'Version' => 'Version',
    'Url has been copied to the clipboard!' => 'Url has been copied to the clipboard!',
    'Invoices have been successfully downloaded.' => 'Invoices have been successfully downloaded.',
    'No invoices available for this customer.' => 'No invoices available for this customer.',
    'Are you sure?' => 'Are you sure?',
    'Attention! This action is irreversible. Please make sure you have downloaded all of the customer’s invoices (if he has any) before clicking on Confirm erasure.' => 'Attention! This action is irreversible. Please make sure you have downloaded all of the customer’s invoices (if he/she has any) before clicking on Confirm erasure.',
    'Cancel action' => 'Cancel action',
    'Confirm Erasure' => 'Confirm Erasure',
    'The customer\'s data has been successfully deleted!' => 'The customer\'s data has been successfully deleted!',
    'Welcome to your GDPR module' => 'Welcome to your GDPR module',
    'This interface will help you to become familiar with the GDPR and give you some guidance to help you become compliant with this regulation.' => 'This interface will help you to become familiar with the GDPR and give you some guidance to help you become compliant with this regulation.',
    'This module meets the main regulation\'s requirements concerning personal data of your customers including :' => 'This module meets the main regulation\'s requirements concerning personal data of your customers including:',
    'The right to access their personal data and data portability' => 'The right to access their personal data and data portability',
    'The right to obtain rectification and/or erasure of their personal data' => 'The right to obtain rectification and/or erasure of their personal data',
    'The right to give and withdraw consent' => 'The right to give and withdraw consent',
    'It also allows you to keep a record of processing activities (especially for access, consent and erasure).' => 'It also allows you to keep a record of processing activities (especially for access, consent and erasure).',
    'Follow our 3 steps to configure your module and help you to become GDPR compliant !' => 'Follow our 3 steps to configure your module and help you to become GDPR compliant!',
    'Manage' => 'Manage',
    'See our Personal data management tab to visualize the data collected by PrestaShop and community modules and manage your customers’ personal data.' => 'See our Personal data management tab to visualize the data collected by PrestaShop and community modules and to manage your customers’ personal data.',
    'Customize' => 'Customize',
    'Customize the consent confirmation checkboxes and consent request message on the different forms of your store, especially for account creation and newsletter subscription.' => 'Customize the consent confirmation checkboxes and consent request message on the different forms of your store, especially for account creation and newsletter subscription.',
    'Keep track' => 'Keep track',
    'Visualize all of your customers’ actions related to their data and manage the erasure requests.' => 'Visualize all of your customers’ actions related to their data and manage the erasure requests.',
    'Note : Please make sure that you have access to the latest version of your installed module(s) to fully benefit the features of our GDPR module. If one or several of your modules do not provide their data list, we invite you to contact directly the developers of these modules.' => 'Note: Please make sure that you have access to the latest version of your installed module(s) to fully benefit the features of our GDPR module. If one or several of your modules do not provide their data list, we invite you to contact directly the developers of these modules.',
    'More information about GDPR' => 'More information about GDPR',
    'Data protection authorities websites' => 'Data protection authorities websites',
    'PrestaShop GDPR whitepaper' => 'PrestaShop GDPR whitepaper',
    'Module\'s documentation' => 'Module\'s documentation',
    'Video' => 'Video',
    'Build article' => 'Build article',
    'Note : These features are intended to help you to become GDPR compliant. However using them does not guarantee that your site is fully compliant with GDPR requirements. It is ' => 'Note: These features are intended to help you to become GDPR compliant. However, using them does not guarantee that your site is fully compliant with GDPR requirements. ',
    'It is your own responsibility' => 'It is your own responsibility',
    'to configure the modules and take all necessary actions to ensure compliance. For any questions, we recommend you to contact a lawyer specializing in personal data legislation questions.' => 'to configure the modules and take all necessary actions to ensure compliance. For any questions, we recommend you to contact a lawyer specializing in personal data legislation questions.',
    'Customer activity list' => 'Customer activity list',
    'Keep track of your customer activity related to data accessibility, consent and erasure.' => 'Keep track of your customer activity related to data accessibility, consent, and erasure.',
    ...
    'This module allows you to :' => 'This module allows you to:',
    'Erase any customer account with his/her personal data collected by your shop if requested by the customer' => 'Erase any customer account with his/her personal data collected by your shop if requested by the customer',
    'Add a consent confirmation checkbox in a module form that collects personal data and customize it' => 'Add a consent confirmation checkbox in a module form that collects personal data and customize it',
    'Allow your customer to consult and export their personal data collected by your shop on their customer account' => 'Allow your customer to consult and export their personal data collected by your shop on their customer account',
    'View all your customers’ actions related to their personal data' => 'View all your customers’ actions related to their personal data',
    'Need help ?' => 'Need help?',
    'Find here the documentation of this module' => 'Find here the documentation of this module',
    'Documentation' => 'Documentation',
    'FAQ' => 'FAQ',
    'You couldn\'t find any answer to your question ?' => 'Couldn\'t find any answer to your question?',
    'Contact us on PrestaShop Addons' => 'Contact us on PrestaShop Addons',
    'Help' => 'Help',
    'List of modules' => 'List of modules',
    'Update all' => 'Update all',
    'Check for update' => 'Check for update',
    'My personal data' => 'My personal data',
    'Access to my data' => 'Access to my data',
    'At any time, you have the right to retrieve the data you have provided to our site. Click on "Get my data" to automatically download a copy of your personal data on a pdf or csv file.' => 'At any time, you have the right to retrieve the data you have provided to our site. Click on "Get my data" to automatically download a copy of your personal data on a pdf or CSV file.',
    'GET MY DATA TO CSV' => 'GET MY DATA TO CSV',
    'GET MY DATA TO PDF' => 'GET MY DATA TO PDF',
    'Rectification & Erasure requests' => 'Rectification & Erasure requests',
    'You have the right to modify all the personal information found in the "My Account" page. For any other request you might have regarding the rectification and/or erasure of your personal data, please contact us through our' => 'You have the right to modify all the personal information found in the "My Account" page. For any other request you might have regarding the rectification and/or erasure of your personal data, please contact us through our',
    'contact page' => 'contact page',
    'We will review your request and reply as soon as possible.' => 'We will review your request and reply as soon as possible.',
    'Drop your child theme archive here or' => 'Drop your child theme archive here or',
    'select file' => 'select file',
    'Please upload one file at a time, .zip. Your child theme will be installed right after that.' => 'Please upload one file at a time, .zip. Your child theme will be installed right after that.',
    'Oops... Upload failed.' => 'Oops... Upload failed.',
    'What happened?' => 'What happened?',
