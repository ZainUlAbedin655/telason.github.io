<?php
/* Smarty version 3.1.33, created on 2019-07-19 10:26:35
  from '/home/telaso5/public_html/themes/wolf_child/templates/checkout/_partials/cart-detailed-product-line.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_5d30f21b7c6f21_46228656',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'cc727ed4c73d4eb42c097f0f9a9aa348187978cd' => 
    array (
      0 => '/home/telaso5/public_html/themes/wolf_child/templates/checkout/_partials/cart-detailed-product-line.tpl',
      1 => 1554459404,
      2 => 'file',
    ),
  ),
...
function content_5d30f21b7c6f21_46228656 (Smarty_Internal_Template $_smarty_tpl) {
...
"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value['name'], ENT_QUOTES, 'UTF-8');?>
    ...
    <br/>
    <?php if (isset($_smarty_tpl->tpl_vars['product']->value['attributes']) && !empty($_smarty_tpl->tpl_vars['product']->value['attributes'])) {?>
    <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['product']->value['attributes'], 'value', false, 'attribute');
if ($_from !== null) {
foreach ($_from as $_smarty_tpl->tpl_vars['attribute']->value => $_smarty_tpl->tpl_vars['value']->value) {
?>
      <div class="product-line-info product-line-info-attribute" data-partnumber="<?php if ($_smarty_tpl->tpl_vars['attribute']->value == 'Shell Size') {
echo htmlspecialchars($_smarty_tpl->tpl_vars['value']->value, ENT_QUOTES, 'UTF-8');
} else {
echo htmlspecialchars($_smarty_tpl->tpl_vars['attribute']->value, ENT_QUOTES, 'UTF-8');
}?>">
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
    <?php }?>
    <div class="cart-part-number part-number-container">
          <section class="part-number product-front-tpl">
          <!--h3>Part Number</h3-->
          <div class="box-container">
          <div class="box" style="width: 100%;">
                <?php if (isset($_smarty_tpl->tpl_vars['product']->value['reference']) && !empty($_smarty_tpl->tpl_vars['product']->value['reference'])) {?>
                    <input type="text" readonly="" name="reference" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value['reference'], ENT_QUOTES, 'UTF-8');?>
" class="part-number-input">
                <?php }?>
                <?php if (isset($_smarty_tpl->tpl_vars['product']->value['attributes']) && !empty($_smarty_tpl->tpl_vars['product']->value['attributes'])) {?>
                  <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['product']->value['attributes'], 'value', false, 'attribute', 'productAttribute', array (
  'index' => true,
));
if ($_from !== null) {
foreach ($_from as $_smarty_tpl->tpl_vars['attribute']->value => $_smarty_tpl->tpl_vars['value']->value) {
$_smarty_tpl->tpl_vars['__smarty_foreach_productAttribute']->value['index']++;
?>
                    <input type="text" readonly="" name="partnumber[<?php echo htmlspecialchars((isset($_smarty_tpl->tpl_vars['__smarty_foreach_productAttribute']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_foreach_productAttribute']->value['index'] : null), ENT_QUOTES, 'UTF-8');?>
]" class="partnumber-input" value="<?php if ($_smarty_tpl->tpl_vars['attribute']->value == 'Shell Size') {
echo htmlspecialchars($_smarty_tpl->tpl_vars['value']->value, ENT_QUOTES, 'UTF-8');
} else {
echo htmlspecialchars($_smarty_tpl->tpl_vars['attribute']->value, ENT_QUOTES, 'UTF-8');
}?>">
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
    ...
    <?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_9039651345d30f21b7b7f58_68947017', 'hook_cart_extra_product_actions');
?>

    <?php if (count($_smarty_tpl->tpl_vars['product']->value['customizations'])) {?>
      <br>
      <?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_18818836145d30f21b7b9722_90105199', 'cart_detailed_product_line_customization');
?>
...
class Block_9039651345d30f21b7b7f58_68947017 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'hook_cart_extra_product_actions' => 
  array (
    0 => 'Block_9039651345d30f21b7b7f58_68947017',
  ),
);
...
class Block_18818836145d30f21b7b9722_90105199 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'cart_detailed_product_line_customization' => 
  array (
    0 => 'Block_18818836145d30f21b7b9722_90105199',
  ),
);
public function callBlock(Smarty_Internal_Template $_smarty_tpl) {
?>
...
"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Product customization','d'=>'Shop.Theme.Global'),$_smarty_tpl ) );?>
</a>
            ...
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                <div class="modal-header">
                  ...
                  <h4 class="modal-title"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Product customization','d'=>'Shop.Theme.Global'),$_smarty_tpl ) );?>
</h4>
                </div>
